...
//  items.forEach(arrayProperty => {
//    for (id in arrayProperty) {
//      if (arrayProperty.id === idNum) {
...
const arrayOfKeys = Object.keys(object).join('');
const strexpectedKeys = expectedKeys.join('');
  if (arrayOfKeys === strexpectedKeys) {
    return true;
  } else {
    return false;
  }
